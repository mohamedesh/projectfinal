    ...
    <main className={`${mc.about} container`}>
      ...
      <article>
        <p>
          ...
          cuisine, de voyage ou de tout autre sujet, Good Corner vous permet de
          créer votre propre collection de liens inspirants, mais aussi de
      ...
      <article>
        <p>
          ...
          facilement organiser vos liens préférés et les mettre à disposition de
          tous, ou les garder précieusement privés. L'expérience sur Good Corner
          est bien plus qu'une simple recherche de liens, c'est une véritable
          exploration interactive du web. Vous pouvez naviguer à travers les
          catégories, plonger dans les profondeurs du savoir et de la
          créativité, et partager vos trouvailles avec des personnes partageant
          les mêmes intérêts.
        </p>
      </article>
      <article>
        <p>
          ...
          plus intrigants, laissez-vous émerveiller par les liens qui
